...
Route::get('become-a-vendor', [BecomeAVendorController::class, 'become_a_vendor'])->name('become-a-vendor');
...
// vendor
Route::post('save-vendor', [BecomeAVendorController::class, 'save_vendor'])->name('save-vendor');
